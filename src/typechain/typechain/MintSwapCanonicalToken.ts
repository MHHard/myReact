...
export interface MintSwapCanonicalTokenInterface extends utils.Interface {
  contractName: "MintSwapCanonicalToken";
  functions: {
...
export interface MintSwapCanonicalToken extends BaseContract {
  contractName: "MintSwapCanonicalToken";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MintSwapCanonicalTokenInterface;
