...
export interface OriginalTokenVaultInterface extends utils.Interface {
  contractName: "OriginalTokenVault";
  functions: {
...
export type MaxDepositUpdatedEvent = TypedEvent<
  [string, BigNumber],
  { token: string; amount: BigNumber }
>;

export type MaxDepositUpdatedEventFilter =
  TypedEventFilter<MaxDepositUpdatedEvent>;

export type MinDepositUpdatedEvent = TypedEvent<
  [string, BigNumber],
  { token: string; amount: BigNumber }
>;

export type MinDepositUpdatedEventFilter =
  TypedEventFilter<MinDepositUpdatedEvent>;
...
export interface OriginalTokenVault extends BaseContract {
  contractName: "OriginalTokenVault";
  ...
  filters: {
    ...
    "Deposited(bytes32,address,address,uint256,uint64,address)"(
      depositId?: null,
      depositor?: null,
      token?: null,
      amount?: null,
    ...
    "MaxDepositUpdated(address,uint256)"(
      token?: null,
      amount?: null
    ): MaxDepositUpdatedEventFilter;
    MaxDepositUpdated(
      token?: null,
      amount?: null
    ): MaxDepositUpdatedEventFilter;

    "MinDepositUpdated(address,uint256)"(
      token?: null,
      amount?: null
    ): MinDepositUpdatedEventFilter;
    MinDepositUpdated(
      token?: null,
      amount?: null
    ): MinDepositUpdatedEventFilter;
