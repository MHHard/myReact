...
export interface SwapBridgeTokenInterface extends utils.Interface {
  contractName: "SwapBridgeToken";
  functions: {
    "allowance(address,address)": FunctionFragment;
    "approve(address,uint256)": FunctionFragment;
    "approveCanonical()": FunctionFragment;
    ...
    "revokeCanonical()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "approveCanonical",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "revokeCanonical",
    values?: undefined
  ): string;
...
export interface SwapBridgeToken extends BaseContract {
  contractName: "SwapBridgeToken";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SwapBridgeTokenInterface;
  ...
  callStatic: {
    ...
    approveCanonical(overrides?: CallOverrides): Promise<void>;
    ...
    revokeCanonical(overrides?: CallOverrides): Promise<void>;
