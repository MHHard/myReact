...
export interface MCNNFTInterface extends utils.Interface {
  ...
  functions: {
    ...
    "crossChain(uint64,uint256,address)": FunctionFragment;
...
export type NFTBridgeUpdatedEventFilter =
  TypedEventFilter<NFTBridgeUpdatedEvent>;
