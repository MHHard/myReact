...
export interface MultiBridgeTokenInterface extends utils.Interface {
...
export interface MultiBridgeToken extends BaseContract {
  contractName: "MultiBridgeToken";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MultiBridgeTokenInterface;
