...
export interface NFTBridgeInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "setDestBridge",
    values: [BigNumberish, string]
  ): string;
  encodeFunctionData(
    functionFragment: "setDestBridges",
    values: [BigNumberish[], string[]]
  ): string;
  encodeFunctionData(
    functionFragment: "setDestNFT",
    values: [string, BigNumberish, string]
  ): string;
  encodeFunctionData(
    functionFragment: "setDestNFTs",
    values: [string, BigNumberish[], string[]]
  ): string;
  encodeFunctionData(
...
export type SetDestBridgeEvent = TypedEvent<
  [BigNumber, string],
  { dstChid: BigNumber; dstNftBridge: string }
>;
...
export type SetOrigNFTEvent = TypedEvent<
  [string, boolean],
  { nft: string; isOrig: boolean }
>;

export type SetOrigNFTEventFilter = TypedEventFilter<SetOrigNFTEvent>;

export type SetTxFeeEvent = TypedEvent<
  [BigNumber, BigNumber],
  { chid: BigNumber; fee: BigNumber }
>;
...
export interface NFTBridge extends BaseContract {
  ...
  filters: {
    ...
    "SetDestBridge(uint64,address)"(
      dstChid?: null,
      dstNftBridge?: null
    ): SetDestBridgeEventFilter;
    SetDestBridge(
      dstChid?: null,
      dstNftBridge?: null
    ): SetDestBridgeEventFilter;

    "SetDestNFT(address,uint64,address)"(
      srcNft?: null,
      dstChid?: null,
      dstNft?: null
    ): SetDestNFTEventFilter;
    SetDestNFT(
      srcNft?: null,
      dstChid?: null,
      dstNft?: null
    ...
    "SetOrigNFT(address,bool)"(
      nft?: null,
      isOrig?: null
    ): SetOrigNFTEventFilter;
