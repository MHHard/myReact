...
export interface MintSwapCanonicalTokenUpgradableFreezableInterface
  extends utils.Interface {
  contractName: "MintSwapCanonicalTokenUpgradableFreezable";
  functions: {
...
export type BridgeSupplyCapUpdatedEvent = TypedEvent<
  [string, BigNumber],
  { bridge: string; supplyCap: BigNumber }
>;

export type BridgeSupplyCapUpdatedEventFilter =
  TypedEventFilter<BridgeSupplyCapUpdatedEvent>;
...
export type TokenSwapCapUpdatedEvent = TypedEvent<
  [string, BigNumber],
  { token: string; cap: BigNumber }
>;

export type TokenSwapCapUpdatedEventFilter =
  TypedEventFilter<TokenSwapCapUpdatedEvent>;
...
export interface MintSwapCanonicalTokenUpgradableFreezable
  ...
  interface: MintSwapCanonicalTokenUpgradableFreezableInterface;
  ...
  callStatic: {
    ...
    freeze(_account: string, overrides?: CallOverrides): Promise<void>;
    ...
    unfreeze(_account: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "BridgeSupplyCapUpdated(address,uint256)"(
      bridge?: null,
      supplyCap?: null
    ): BridgeSupplyCapUpdatedEventFilter;
    ...
    "TokenSwapCapUpdated(address,uint256)"(
      token?: null,
      cap?: null
    ): TokenSwapCapUpdatedEventFilter;
    TokenSwapCapUpdated(
      token?: null,
      cap?: null
    ): TokenSwapCapUpdatedEventFilter;
