...
import type {
  GovernedOwnerProxy,
  GovernedOwnerProxyInterface,
} from "../GovernedOwnerProxy";
...
type GovernedOwnerProxyConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: GovernedOwnerProxyConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class GovernedOwnerProxy__factory extends ContractFactory {
  constructor(...args: GovernedOwnerProxyConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
      super(_abi, _bytecode, args[0]);
    }
    this.contractName = "GovernedOwnerProxy";
  }

  deploy(
    _initializer: string,
    overrides?: Overrides & { from?: string | Promise<string> }
  ): Promise<GovernedOwnerProxy> {
    return super.deploy(
      _initializer,
      overrides || {}
    ) as Promise<GovernedOwnerProxy>;
  }
  getDeployTransaction(
    _initializer: string,
    overrides?: Overrides & { from?: string | Promise<string> }
  ): TransactionRequest {
    return super.getDeployTransaction(_initializer, overrides || {});
  }
  attach(address: string): GovernedOwnerProxy {
    return super.attach(address) as GovernedOwnerProxy;
  }
  connect(signer: Signer): GovernedOwnerProxy__factory {
    return super.connect(signer) as GovernedOwnerProxy__factory;
  }
  static readonly contractName: "GovernedOwnerProxy";
  public readonly contractName: "GovernedOwnerProxy";
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): GovernedOwnerProxyInterface {
    return new utils.Interface(_abi) as GovernedOwnerProxyInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): GovernedOwnerProxy {
    return new Contract(address, _abi, signerOrProvider) as GovernedOwnerProxy;
  }
}
