...
export type StakingRewardClaimedEvent = TypedEvent<
  [string, BigNumber],
  { recipient: string; reward: BigNumber }
>;

export type StakingRewardClaimedEventFilter =
  TypedEventFilter<StakingRewardClaimedEvent>;
...
export type StakingRewardContributedEventFilter =
  TypedEventFilter<StakingRewardContributedEvent>;
...
export interface StakingReward extends BaseContract {
  ...
  filters: {
    ...
    "StakingRewardClaimed(address,uint256)"(
      recipient?: string | null,
      reward?: null
    ): StakingRewardClaimedEventFilter;
