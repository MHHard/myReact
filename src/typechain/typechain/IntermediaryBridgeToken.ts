...
export interface IntermediaryBridgeTokenInterface extends utils.Interface {
  contractName: "IntermediaryBridgeToken";
  functions: {
...
export interface IntermediaryBridgeToken extends BaseContract {
  contractName: "IntermediaryBridgeToken";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IntermediaryBridgeTokenInterface;
