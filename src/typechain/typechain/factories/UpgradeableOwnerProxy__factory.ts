...
import type {
  ...
  UpgradeableOwnerProxyInterface,
} from "../UpgradeableOwnerProxy";
...
export class UpgradeableOwnerProxy__factory {
  static readonly abi = _abi;
  static createInterface(): UpgradeableOwnerProxyInterface {
    return new utils.Interface(_abi) as UpgradeableOwnerProxyInterface;
  }
  static connect(
    address: string,
