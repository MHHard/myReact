...
export declare namespace MsgDataTypes {
  ...
  export type BridgeTransferParamsStructOutput = [
    string,
    string[],
    string[],
    BigNumber[]
...
export interface MessageBusInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [
      MsgDataTypes.BridgeTransferParamsStruct,
      MsgDataTypes.MsgWithTransferExecutionParamsStruct
    ]
  ): string;
  encodeFunctionData(
...
export type FeePerByteUpdatedEventFilter =
  TypedEventFilter<FeePerByteUpdatedEvent>;

export type LiquidityBridgeUpdatedEvent = TypedEvent<
  [string],
  { liquidityBridge: string }
>;

export type LiquidityBridgeUpdatedEventFilter =
  TypedEventFilter<LiquidityBridgeUpdatedEvent>;
...
export type MessageWithTransferEventFilter =
  TypedEventFilter<MessageWithTransferEvent>;
...
export type PegBridgeUpdatedEventFilter =
  TypedEventFilter<PegBridgeUpdatedEvent>;
...
export type PegBridgeV2UpdatedEventFilter =
  TypedEventFilter<PegBridgeV2UpdatedEvent>;
...
export type PegVaultV2UpdatedEventFilter =
  TypedEventFilter<PegVaultV2UpdatedEvent>;
