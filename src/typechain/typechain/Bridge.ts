...
export type MaxSendUpdatedEvent = TypedEvent<
  [string, BigNumber],
...
export type MinAddUpdatedEvent = TypedEvent<
  [string, BigNumber],
  { token: string; amount: BigNumber }
>;
...
export type MinSendUpdatedEvent = TypedEvent<
  [string, BigNumber],
  { token: string; amount: BigNumber }
>;
...
export type ResetNotificationEvent = TypedEvent<
  [BigNumber],
  { resetTime: BigNumber }
>;

export type ResetNotificationEventFilter =
  TypedEventFilter<ResetNotificationEvent>;
...
export type SignersUpdatedEvent = TypedEvent<
  [string[], BigNumber[]],
...
export interface Bridge extends BaseContract {
  ...
  filters: {
    ...
    "MaxSendUpdated(address,uint256)"(
      token?: null,
      amount?: null
    ): MaxSendUpdatedEventFilter;
    MaxSendUpdated(token?: null, amount?: null): MaxSendUpdatedEventFilter;

    "MinAddUpdated(address,uint256)"(
      token?: null,
      amount?: null
    ): MinAddUpdatedEventFilter;
    MinAddUpdated(token?: null, amount?: null): MinAddUpdatedEventFilter;

    "MinSendUpdated(address,uint256)"(
      token?: null,
      amount?: null
    ): MinSendUpdatedEventFilter;
    MinSendUpdated(token?: null, amount?: null): MinSendUpdatedEventFilter;
    ...
    "ResetNotification(uint256)"(
      resetTime?: null
    ): ResetNotificationEventFilter;
    ...
    "SignersUpdated(address[],uint256[])"(
      _signers?: null,
      _powers?: null
    ): SignersUpdatedEventFilter;
