...
export interface MultiBridgeTokenPermitInterface extends utils.Interface {
  contractName: "MultiBridgeTokenPermit";
  functions: {
...
export interface MultiBridgeTokenPermit extends BaseContract {
  contractName: "MultiBridgeTokenPermit";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MultiBridgeTokenPermitInterface;
