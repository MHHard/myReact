...
interface IncentiveEventsRewardInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "claimDeadlines",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setClaimDeadline",
  ...
  events: {
    "IncentiveRewardClaimed(address,uint256,address,uint256)": EventFragment;
...
export class IncentiveEventsReward extends BaseContract {
  ...
  interface: IncentiveEventsRewardInterface;
  ...
  filters: {
    "IncentiveRewardClaimed(address,uint256,address,uint256)"(
