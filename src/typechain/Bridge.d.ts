...
interface BridgeInterface extends ethers.utils.Interface {
  functions: {
    "addGovener(address)": FunctionFragment;
    ...
    "executeTransfer(bytes32)": FunctionFragment;
    ...
    "removeGovener(address)": FunctionFragment;
    "removePauser(address)": FunctionFragment;
    "renounceGovener()": FunctionFragment;
    ...
    "updateSigners(address[],uint256[],bytes[],address[],uint256[])": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "addGovener", values: [string]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "removeGovener",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "renounceGovener",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "addGovener", data: BytesLike): Result;
  ...
  events: {
    ...
    "TransferExecuted(bytes32,address,address,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "TransferExecuted"): EventFragment;
...
export class Bridge extends BaseContract {
  ...
  callStatic: {
    addGovener(_account: string, overrides?: CallOverrides): Promise<void>;
    ...
    executeTransfer(id: BytesLike, overrides?: CallOverrides): Promise<void>;
    ...
    removeGovener(_account: string, overrides?: CallOverrides): Promise<void>;

    removePauser(account: string, overrides?: CallOverrides): Promise<void>;

    renounceGovener(overrides?: CallOverrides): Promise<void>;
