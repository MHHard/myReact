...
export type DelegationUpdateEventFilter =
  TypedEventFilter<DelegationUpdateEvent>;
...
export type SlashAmtCollectedEvent = TypedEvent<
  [string, BigNumber],
  { recipient: string; amount: BigNumber }
>;

export type SlashAmtCollectedEventFilter =
  TypedEventFilter<SlashAmtCollectedEvent>;
...
export interface Staking extends BaseContract {
  ...
  functions: {
    ...
    getBondedValidatorsTokens(
      overrides?: CallOverrides
    ): Promise<[DataTypes.ValidatorTokensStructOutput[]]>;
  ...
  filters: {
    ...
    "SlashAmtCollected(address,uint256)"(
      recipient?: string | null,
      amount?: null
    ): SlashAmtCollectedEventFilter;
    SlashAmtCollected(
      recipient?: string | null,
      amount?: null
    ): SlashAmtCollectedEventFilter;
