...
export interface FraxBridgeTokenInterface extends utils.Interface {
  contractName: "FraxBridgeToken";
  functions: {
...
export interface FraxBridgeToken extends BaseContract {
  contractName: "FraxBridgeToken";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FraxBridgeTokenInterface;
