...
import type {
  BridgeOwnerProxy,
  BridgeOwnerProxyInterface,
} from "../BridgeOwnerProxy";
...
export class BridgeOwnerProxy__factory {
  static readonly abi = _abi;
  static createInterface(): BridgeOwnerProxyInterface {
    return new utils.Interface(_abi) as BridgeOwnerProxyInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BridgeOwnerProxy {
    return new Contract(address, _abi, signerOrProvider) as BridgeOwnerProxy;
  }
}
