...
import type {
  PeggedTokenBridgeV2,
  PeggedTokenBridgeV2Interface,
} from "../PeggedTokenBridgeV2";
...
type PeggedTokenBridgeV2ConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: PeggedTokenBridgeV2ConstructorParams
...
export class PeggedTokenBridgeV2__factory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(
      _sigsVerifier,
      overrides || {}
    ) as Promise<PeggedTokenBridgeV2>;
  }
