...
import type {
  MessageOwnerProxy,
  MessageOwnerProxyInterface,
} from "../MessageOwnerProxy";
...
export class MessageOwnerProxy__factory {
  static readonly abi = _abi;
  static createInterface(): MessageOwnerProxyInterface {
    return new utils.Interface(_abi) as MessageOwnerProxyInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MessageOwnerProxy {
    return new Contract(address, _abi, signerOrProvider) as MessageOwnerProxy;
  }
}
