...
import type { SgnOwnerProxy, SgnOwnerProxyInterface } from "../SgnOwnerProxy";
...
export class SgnOwnerProxy__factory {
  static readonly abi = _abi;
  static createInterface(): SgnOwnerProxyInterface {
    return new utils.Interface(_abi) as SgnOwnerProxyInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SgnOwnerProxy {
    return new Contract(address, _abi, signerOrProvider) as SgnOwnerProxy;
  }
}
