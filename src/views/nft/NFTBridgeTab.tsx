      ...
      <div className={classes.bottomButtonContainer}>
        {isAllowShowApprovalButton && isNFTOverviewLoading && nftBridgeMode !== NFTBridgeMode.NATIVE && (
          <Button
            ...
            disabled={!isNFTOverviewLoading || !selectedNFT || nftApproved || transferRelatedFeatureDisabled}
        ...
        <Button
          ...
          className={classes.nftBtn}
          disabled={!selectedNFT || !isNFTOverviewLoading || !nftApproved || transferRelatedFeatureDisabled}
