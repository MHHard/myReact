...
export interface SingleBridgeTokenInterface extends utils.Interface {
  contractName: "SingleBridgeToken";
  functions: {
...
export interface SingleBridgeToken extends BaseContract {
  contractName: "SingleBridgeToken";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SingleBridgeTokenInterface;
