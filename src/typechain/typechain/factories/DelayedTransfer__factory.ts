...
import type {
  DelayedTransfer,
  DelayedTransferInterface,
} from "../DelayedTransfer";
...
export class DelayedTransfer__factory {
  static readonly abi = _abi;
  static createInterface(): DelayedTransferInterface {
    return new utils.Interface(_abi) as DelayedTransferInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): DelayedTransfer {
    return new Contract(address, _abi, signerOrProvider) as DelayedTransfer;
  }
}
