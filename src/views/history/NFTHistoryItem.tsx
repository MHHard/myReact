...
export const NFTHistoryItem = (props: NFTHistoryItemProps): JSX.Element => {
  ...
  const { item, nftList, onLocalItemRemoved, getNetworkById } = props;
          ...
          <div className={classes.itemtitle} style={isMobile ? { minWidth: 0 } : { minWidth: 160 }}>
            ...
            <div className={classes.chaindes}>
              <a
                ...
                href={formatBlockExplorerUrlWithTxHash(
                  { chainId: srcChain.chainId, txHash: item.srcTx },
                  getNetworkById,
                )}
                target="_blank"
            ...
            <div className={classes.chaindes}>
              {item.dstTx ? (
                <a
                  ...
                  href={formatBlockExplorerUrlWithTxHash(
                    { chainId: dstChain.chainId, txHash: item.dstTx },
                    getNetworkById,
                  )}
                  target="_blank"
                  rel="noopener noreferrer"
